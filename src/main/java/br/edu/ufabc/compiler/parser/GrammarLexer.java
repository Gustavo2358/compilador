...
public class GrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "OP_ADD", "OP_MULT", 
			"OP_REL", "OP_BOOL", "TEXTO", "INTEGER", "REAL", "LOGICO", "ID", "HEXADECIMAL", 
			"BINARY", "OCTAL", "SC", "COMMA", "WS", "AP", "FP", "SINGLE_LINE_COMMENT"
		};
	}
